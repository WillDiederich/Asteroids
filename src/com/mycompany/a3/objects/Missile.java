...
public class Missile extends GameObject implements IMovable, ICollider, IDrawable, ISelectable {
	...
	public void draw(Graphics g) {
		...
		g.fillRect((int)this.getLocationX(), (int)this.getLocationY(), 25, 35);
	}	
	...
	public String toString() {
		String missileOutput = "";
		missileOutput += "Missile: " + 
				  		...
				  		" fuel=" + this.fuelReserve + 
				  		"\n";		
		return missileOutput;
	}
